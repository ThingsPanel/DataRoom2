...
public class CategoryServiceImpl extends ServiceImpl<CategoryDao, CategoryEntity> implements ICategoryService {
    ...
    public List<CategoryVO> getTree(CategorySearchDTO searchDTO) {
        ...
        wrapper.eq(StringUtils.isNotBlank(searchDTO.getTenantId()), CategoryEntity::getTenantId, searchDTO.getTenantId());
    ...
    public List<String> getAllChildrenId(String id) {
        ...
        wrapper.eq(StringUtils.isNotBlank(category.getTenantId()), CategoryEntity::getTenantId, category.getTenantId());
        List<CategoryEntity> list = this.list(wrapper);
    ...
    public boolean checkNameRepeat(CategoryEntity entity) {
        ...
        queryWrapper.eq(StringUtils.isNotBlank(entity.getTenantId()), CategoryEntity::getTenantId, entity.getTenantId());
