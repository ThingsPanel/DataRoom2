...
const setting = [
  ...
  { 
    ...
    options: [
      { label: '后阶梯', value: 'stepAfter' },
      { label: '前阶梯', value: 'stepBefore' },
      { label: '中阶梯', value: 'step' }
    ],
    value: 'stepAfter',
    tabName: 'custom',
    groupName: 'line'
