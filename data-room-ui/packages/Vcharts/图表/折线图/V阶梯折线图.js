...
const setting = [
  ...
  { 
    ...
    options: [
      ...
      { label: '阶梯 (后)', value: 'stepAfter' } // 参考 spec，默认为 stepAfter
    ], 
    value: 'stepAfter', // 默认阶梯 (后)
    tabName: 'custom', 
    groupName: 'graph' 
  },
  { label: '显示点', type: 'switch', field: 'pointVisible', optionField: 'point.visible', value: false, tabName: 'custom', groupName: 'graph' }, // 参考 spec，默认不显示
...
// 默认 VChart Option (Spec) for Step Line Chart
const option = {
  type: 'line',
  data: [data],
  xField: 'time',
