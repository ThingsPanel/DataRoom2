...
const setting = [
  ...
  { label: '最小值字段', type: 'select', field: 'minField', optionField: 'yField.0', multiple: false, value: '', tabName: 'data' },
  { label: '最大值字段', type: 'select', field: 'maxField', optionField: 'yField.1', multiple: false, value: '', tabName: 'data' },
  // 图表方向
  { 
    label: '图表方向', 
    type: 'select', 
